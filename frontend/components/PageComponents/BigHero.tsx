                  ...
                  <div className="text-gray-600 dark:text-gray-400 mb-4">
                    ...
                    {posts[0].categories && posts[0].categories.length > 0 ? (
                      posts[0].categories.map((category, index) => (
                        <span key={`${posts[0].id}-category-${category}-${index}`} className="inline-block text-xs font-medium tracking-wider uppercase text-white">
                      ...
                      <div className="text-gray-600 dark:text-gray-400 mb-4">
                        ...
                        {post.categories && post.categories.length > 0 ? (
                          post.categories.map((category, index) => (
                            <span key={`${post.id}-category-${category}-${index}`} className="inline-block text-xs font-medium tracking-wider uppercase text-white">
                              <CategoryName categoryId={category} />
                            </span>
                          ))
                        ) : (
