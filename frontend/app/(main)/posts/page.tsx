...
import ChapterIcon from '@/components/UI/Icons/Chapter';
...
import BlogPostCardList from '@/components/UI/Cards/BlogPostCardList';
...
const PostsContent: React.FC = () => {
  const filter = 'latest'; // Default filter
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 lg:max-w-4xl space-y-8">
            ...
            {(selectedCategory || searchParams?.get('query')) && (
              <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-lg overflow-hidden mb-8">
                <div className="p-6">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {selectedCategory && (
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl text-sm font-medium text-blue-700">
                        <span>
                          {(() => {
                            const categoryParam = searchParams?.get('category');
                            ...
                            if (subcategoryParam) {
                              ...
                              const subCat = categories
                                ...
                                .find(
                                  (child) => child.slug === subcategoryParam
                                );
                    ...
                    {searchParams?.get('query') && (
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-xl text-sm font-medium text-green-700">
                        <svg
                          className="w-4 h-4"
                          fill="none"
                          stroke="currentColor"
                    ...
                    {loading && (
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-xl text-sm font-medium text-gray-600">
              ...
              <div className="space-y-6">
                {filteredPosts.length === 0 && !loading ? (
                  ...
                  filteredPosts.map((post) => (
                    <BlogPostCardList key={post.id} post={post} />
                  ))
                )}
              </div>
            </section>
            ...
            {/* Pagination */}
            <div className="min-h-[72px] flex items-center justify-between bg-white px-4 py-3 sm:px-6 mt-8 pagination-container">
              {totalPages > 1 ? (
                <>
...
// Main Posts component wrapped with Suspense
