...
import ShopHeader from '@/components/PageComponents/Shop/ShopHeader';
import ShopSidebar from '@/components/PageComponents/Shop/ShopSidebar';
import ProductsGrid from '@/components/PageComponents/Shop//ProductsGrid';
import { useProducts } from '@/hooks/useProducts';
import useFilters from '@/hooks/useFilters';
import ShopPageSkeleton from '@/components/PageComponents/Shop/ShopPageSkeleton';
...
const ProductsContent: React.FC = () => {
  ...
  useEffect(() => {
    if (loading) {
      ...
      const timeSpentLoading =
        loadedTime - (loadingStartTime.current || loadedTime);
      const minDisplayTime = siteConfig.skeletonMinTime; // ms

      if (timeSpentLoading < minDisplayTime) {
        const remainingTime = minDisplayTime - timeSpentLoading;
        setTimeout(() => {
