...
import { fetchMyThreads, fetchForumStats } from '@/services/forum';
  ...
  const loadThreads = useCallback(
    async (page: number = 1, reset: boolean = false) => {
      try {
        ...
        // Always fetch only current user's threads since this is a profile page
        if (!isAuthenticated) {
          setThreads([]);
        ...
        const response = await fetchMyThreads({
          page,
          pageSize: 10,
        ...
        console.error('Error loading my threads:', error);
      ...
      <div className="min-h-screen bg-white">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-center min-h-[50vh]">
            <div className="bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 shadow-sm p-8 text-center max-w-md">
              ...
              <p className="text-gray-600 mb-6">
                You need to be signed in to view your forum threads.
              </p>
              <Link
                href="/signin"
                className="inline-flex items-center px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-white rounded-lg 
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-gray-600">
                  Manage and view all your forum discussions
                </p>
              </div>
              <Link
                href="/forum/create"
                      ...
                      <>
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 3.582 9 8z"
                          />
                        </svg>
                        <h3 className="text-lg font-medium text-gray-900 mb-2">
