...
const Products: React.FC = () => {
  ...
  }, [location.search]); // Remove circular dependencies

  // Add separate useEffect to trigger fetchData when filters, orderBy, or page change
  useEffect(() => {
  ...
  // Separate useEffect for URL parameters that depend on categories being loaded
  useEffect(() => {
  ...
  const handleFilterChange = useCallback(
    ...
    [fetchSubCategoriesData, fetchSubLocationsData] // Keep only the stable function dependencies
  );
